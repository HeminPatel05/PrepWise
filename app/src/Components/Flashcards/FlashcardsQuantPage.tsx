...
const FlashcardQuantPage: React.FC = () => {
  const [sections] = useState<Section[]>([
    { title: "Algebra", totalQuestions: 5, averageTimePerQuestion: 1 },
    { title: "Number Properties", totalQuestions: 5, averageTimePerQuestion: 1.2 },
    { title: "Statistics", totalQuestions: 5, averageTimePerQuestion: 1 },
  ]);
...
export default FlashcardQuantPage;
